...
namespace Market.Infrastructure.Extantions
{
    public static class ConfigurationServices
    {
        public static IServiceCollection AddApplication(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<IReturnCustomerService<ReturnCustomerRequest, ReturnCustomerUpdateRequest, ReturnCustomerResponse>, ReturnCustomerService>();
            services.AddScoped<IReturnOrganizationService<ReturnOrganizationRequest, ReturnOrganizationUpdateRequest, ReturnOrganizationResponse>, ReturnOrganizationService>();
            services.AddScoped<IProductService<ProductRequest, ProductUpdateRequest, ProductResponse>, ProductServise>();
            ...
            services.AddScoped<ICustomerService<CustomerRequest, CustomerUpdateRequest, CustomerResponse>, CustomerService>();
            services.AddScoped<IAddressService<AddressRequest, AddressUpdateRequest, AddressResponse>, AddressService>();
            services.AddScoped<IOrganizationService<OrganizationRequest, OrganizationUpdateRequest, OrganizationResponse>, OrganizationService>();
            ...
            services.AddScoped<IPurchaseService<PurchaseRequest, PurchaseUpdateRequest, PurchaseResponse>, PurchaseService>();
            services.AddScoped<ISellService<SellRequest, SellUpdateRequest, SellResponse>, SellService>();
