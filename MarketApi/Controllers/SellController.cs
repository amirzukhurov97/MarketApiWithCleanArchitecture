...
namespace MarketApi.Controllers
{
    ...
    public class SellController(ISellService<SellRequest, SellUpdateRequest, SellResponse> service, ILogger<SellController> logger) : ControllerBase
    {
        [HttpPost]
        [Authorize(Roles = "admin")]
        public ActionResult<string> Create([FromBody]SellRequest productRequest)
        {
            try
            {                
        ...
        [HttpPut]
        [Authorize(Roles = "admin")]
        public IActionResult Put([FromBody]SellUpdateRequest saleUpdate)
        {
            try
            {
